...
public class TelaClientes extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jTextField10, jTextField3, jTextField8, jTextField9, txtNomeFunc});
    ...
    private void btCadastrarFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCadastrarFuncionarioActionPerformed
        ...
        c.setNomeCliente(txtNomeFunc.getText());
        c.setEmailCliente(jTextField8.getText());
        c.setTelefoneCliente(jTextField5.getText());
        c.setCepCliente(jTextField10.getText());
        c.setRuaCliente(jTextField9.getText());
        c.setNumeroCliente(jTextField4.getText());
        c.setBairroCliente(jTextField3.getText());
        c.setComplementoCliente(jTextField11.getText());
        c.create();
        this.dispose();
